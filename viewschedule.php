...
if($result = mysqli_query($con, $sql)){
    if(mysqli_num_rows($result) > 0){
		...
		echo "<td>".'<a href="viewstats.php?id='.$schid.'"><input type="submit" value="Stats"/></a>'."</td>";
            echo "</tr>";
        }
        echo "</tbody>";
        // Free result set
...
<?php
echo '<center><a href="players.php?id='.$_GET['id'].'"><input type="submit" value="Add Game"/></a></center>';
?>
<br><br>
